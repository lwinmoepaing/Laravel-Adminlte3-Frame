  ...
  <div class="container main-wrapper mt-2">
    ...
    <nav aria-label="breadcrumb" class="mx-auto max-w-600">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">
            <a href="{{ route('admin.data.department') }}" role="button">Create</a>
          </li>
          <li class="breadcrumb-item active" aria-current="page">
            Edit
          </li>
    ...
    <div class="card p-3 mt-3 mx-auto max-w-600" href="#!">
        <div class="w-100">
            ...
            <form action="{{route('admin.data.department-create-submit')}}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('department_name') is-invalid @enderror" id="nameInput" name="department_name" value="{{ old('department_name') ? old('department_name') : '' }}">
