  ...
  <div class="container main-wrapper mt-2">
    ...
    <div class="card p-3 mt-3 mx-auto max-w-600" href="#!">
        <div class="w-100">
            ...
            <form action="{{route('admin.data.division-edit-submit', ['id' => $division->id])}}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('division_name') is-invalid @enderror" id="nameInput" name="division_name" value="{{ old('division_name') ? old('division_name') : $division->division_name }}">
