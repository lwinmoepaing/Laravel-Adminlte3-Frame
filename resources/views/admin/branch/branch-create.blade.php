  ...
  <div class="container main-wrapper mt-2">
    ...
    <div class="card p-3 mt-3 mx-auto max-w-600" href="#!">
        <div class="w-100">
            ...
            <form action="{{route('admin.data.branch-create-submit')}}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('branch_name') is-invalid @enderror" id="nameInput" name="branch_name" value="{{ old('branch_name') ? old('branch_name') : '' }}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('branch_address') is-invalid @enderror" id="nameInput" name="branch_address" value="{{ old('branch_address') ? old('branch_address') : '' }}">
                            <div class="invalid-feedback">
