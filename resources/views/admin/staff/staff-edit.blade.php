  ...
  <div class="container main-wrapper mt-2">
    ...
    <div class="card p-3 mt-3 mx-auto max-w-600" href="#!">
        <div class="w-100">
            ...
            <form action="{{route('admin.data.staff-edit-submit', ['id' => $staff->id])}}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('name') is-invalid @enderror" id="nameInput" name="name" value="{{ old('name') ? old('name') : $staff->name }}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') ? old('phone') : $staff->phone}}">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="branch_id" name="branch_id">
                                ...
                                <option
                                    value="{{ $branch->id }}"
                                    {{ (old('branch_id') == $branch->id ? 'selected' : $staff->branch_id == $branch->id )? 'selected' : ''}}
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="department_id" name="department_id">
                                ...
                                <option
                                    value="{{ $department->id }}"
                                    {{ (old('department_id') == $department->id ? 'selected' : $staff->department_id == $department->id) ? 'selected' : ''}}
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="staff_role_id" name="staff_role_id">
                                ...
                                <option
                                    value="{{ $staff_role->id }}"
                                    {{ (old('staff_role_id') == $staff_role->id ? 'selected' : $staff->staff_role_id == $staff_role->id) ? 'selected' : ''}}
                                >{{ $staff_role->name }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        ...
                        <a href="{{ route('admin.data.staff')}}" role="button" class="btn btn-outline-danger btn-block icon-btn-position"><i class="fa text-white fa-back"></i> Cancel </a>
                    </div>
                </div>
